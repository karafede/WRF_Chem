...
yesterday_folder_O3 <- paste0("/research/cesam/AirQuality/WRFChem_test_MW_ifort/", date_yesterday,"/O3")
yesterday_folder_CO <- paste0("/research/cesam/AirQuality/WRFChem_test_MW_ifort/", date_yesterday,"/CO")
yesterday_folder_SO2 <- paste0("/research/cesam/AirQuality/WRFChem_test_MW_ifort/", date_yesterday,"/SO2")
yesterday_folder_NO2 <- paste0("/research/cesam/AirQuality/WRFChem_test_MW_ifort/", date_yesterday,"/NO2")
yesterday_folder_PM10 <- paste0("/research/cesam/AirQuality/WRFChem_test_MW_ifort/", date_yesterday,"/PM10")
yesterday_folder_PM25 <- paste0("/research/cesam/AirQuality/WRFChem_test_MW_ifort/", date_yesterday,"/PM25")
