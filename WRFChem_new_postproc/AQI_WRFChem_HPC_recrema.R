...
setwd("/research/cesam/AirQuality/WRFChem_test_MW_ifort/RECREMA")
...
for(i in 25:length(filenames_PM25)) {
  ...
  year <- str_sub(filenames_PM25[i], start = 6, end = 9)
  month <- str_sub(filenames_PM25[i], start = 10, end = 11)
  day <- str_sub(filenames_PM25[i], start = 12, end = 13)
  time <- str_sub(filenames_PM25[i], start = 15, end = 16)
