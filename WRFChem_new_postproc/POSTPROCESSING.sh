...
/apps/R/R-3.3.2/bin/Rscript /research/cesam/fog/WRF/WRF_UAE/scripts/nc_WRFChem_post_proc_d01.R ${date}
...
# process AQI data
/apps/R/R-3.3.2/bin/Rscript /research/cesam/fog/WRF/WRF_UAE/scripts/AQI_WRFChem_HPC.R ${date}
