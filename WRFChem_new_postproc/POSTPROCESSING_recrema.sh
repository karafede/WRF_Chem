...
#/apps/R/R-3.3.2/bin/Rscript /research/cesam/fog/WRF/WRF_UAE/scripts/nc_WRFChem_post_proc_d01_recrema.R ${date}
/apps/R/R-3.3.2/bin/Rscript /research/cesam/fog/WRF/WRF_UAE/scripts/nc_WRFChem_post_proc_d01_recrema_raster_mask.R ${date}
...
# process AQI data
#/apps/R/R-3.3.2/bin/Rscript /research/cesam/fog/WRF/WRF_UAE/scripts/AQI_WRFChem_HPC_recrema.R ${date}
/apps/R/R-3.3.2/bin/Rscript /research/cesam/fog/WRF/WRF_UAE/scripts/AQI_WRFChem_HPC_recrema_raster_mask.R ${date}
