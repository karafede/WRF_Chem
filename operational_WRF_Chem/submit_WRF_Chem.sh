...
bsub -n 96 -R "span[ptile=24]" -W 6:00 -q general -J WRF_Chm -o WRF_Chm.%J.out -e WRF_Chm.%J.err "/disk3/fkaragulian/WRF_UAE/scripts/execute_Model_lsf.sh 1>/home/fkaragulian/log/chemrun.log 2>/home/fkaragulian/log/chem-error.log"

#bsub -n 96 -K -U wrf_chem_00 -R "span[ptile=24]" -W 6:00 -q general -J WRF_Chm -o WRF_Chm.%J.out -e WRF_Chm.%J.err "/disk3/fkaragulian/WRF_UAE/scripts/execute_Model_lsf.sh 1>/home/fkaragulian/log/chemrun.log 2>/home/fkaragulian/log/chem-error.log"
