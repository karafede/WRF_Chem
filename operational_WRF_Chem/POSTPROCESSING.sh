...
# copy last 24h data from the previous day
## /apps/R/R-3.3.2/bin/Rscript /home/fkaragulian/WRF_UAE/scripts/eventually_copy_AQ_data_24h_day_before.R ${date} ${date_yesterday} 
...
rsync -avz ${wrfout}/PM10/*.tif fkaragulian@cesam-web-uat:/data/scripts_cron/forecast_wrf_chem/PM10 
rsync -avz ${wrfout}/PM25/*.tif fkaragulian@cesam-web-uat:/data/scripts_cron/forecast_wrf_chem/PM25 
rsync -avz ${wrfout}/NO2/*.tif fkaragulian@cesam-web-uat:/data/scripts_cron/forecast_wrf_chem/NO2 
rsync -avz ${wrfout}/SO2/*.tif fkaragulian@cesam-web-uat:/data/scripts_cron/forecast_wrf_chem/SO2 
rsync -avz ${wrfout}/CO/*.tif fkaragulian@cesam-web-uat:/data/scripts_cron/forecast_wrf_chem/CO 
rsync -avz ${wrfout}/O3/*.tif fkaragulian@cesam-web-uat:/data/scripts_cron/forecast_wrf_chem/O3

rsync -avz ${wrfout}/PM10/*.tif fkaragulian@cesam-web-dev:/data/scripts_cron/forecast_wrf_chem/PM10 
rsync -avz ${wrfout}/PM25/*.tif fkaragulian@cesam-web-dev:/data/scripts_cron/forecast_wrf_chem/PM25 
rsync -avz ${wrfout}/NO2/*.tif fkaragulian@cesam-web-dev:/data/scripts_cron/forecast_wrf_chem/NO2 
rsync -avz ${wrfout}/SO2/*.tif fkaragulian@cesam-web-dev:/data/scripts_cron/forecast_wrf_chem/SO2 
rsync -avz ${wrfout}/CO/*.tif fkaragulian@cesam-web-dev:/data/scripts_cron/forecast_wrf_chem/CO 
rsync -avz ${wrfout}/O3/*.tif fkaragulian@cesam-web-dev:/data/scripts_cron/forecast_wrf_chem/O3
