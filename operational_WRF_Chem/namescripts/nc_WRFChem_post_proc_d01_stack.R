...
writeRaster(BBB, "AQ_12km_WRFChem_2017092800_PM10.tif" , options= "INTERLEAVE=BAND", overwrite=T)
...
writeRaster(BBB, "AQ_12km_WRFChem_2017092800_PM25.tif" , options= "INTERLEAVE=BAND", overwrite=T)
...
writeRaster(BBB, "AQ_12km_WRFChem_2017092800_NO2.tif" , options= "INTERLEAVE=BAND", overwrite=T)
...
writeRaster(BBB, "AQ_12km_WRFChem_2017092800_CO.tif" , options= "INTERLEAVE=BAND", overwrite=T)
...
writeRaster(BBB, "AQ_12km_WRFChem_2017092800_SO2.tif" , options= "INTERLEAVE=BAND", overwrite=T)
...
writeRaster(BBB, "AQ_12km_WRFChem_2017092800_O3.tif" , options= "INTERLEAVE=BAND", overwrite=T)
...
setwd("D:/Op_WRF_Chem/2017092800/images_png/12km_PM10")
...
WRF_STACK_image <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_PM10.tif")
output_folder <- "D:/Op_WRF_Chem/2017092800/images_png/12km_PM10/"
...
MASS_images <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_PM10.tif")

for (i in 1:length(MASS_images@layers)) {
  TITLE <- paste(TS[i], " (UTC)")
  name_time <- TS[i]
  MASS_images <- raster("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_PM10.tif", band = i)
  # plot(MASS_images)
...
WRF_STACK_image <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_PM25.tif")
output_folder <- "D:/Op_WRF_Chem/2017092800/images_png/12km_PM25/"
...
MASS_images <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_PM25.tif")

for (i in 1:length(MASS_images@layers)) {
  TITLE <- paste(TS[i], " (UTC)")
  name_time <- TS[i]
  MASS_images <- raster("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_PM25.tif", band = i)
  # plot(MASS_images)
...
WRF_STACK_image <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_CO.tif")
output_folder <- "D:/Op_WRF_Chem/2017092800/images_png/12km_CO/"
...
MASS_images <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_CO.tif")

for (i in 1:length(MASS_images@layers)) {
  TITLE <- paste(TS[i], " (UTC)")
  name_time <- TS[i]
  MASS_images <- raster("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_CO.tif", band = i)
  # plot(MASS_images)
...
WRF_STACK_image <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_NO2.tif")
output_folder <- "D:/Op_WRF_Chem/2017092800/images_png/12km_NO2/"
...
MASS_images <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_NO2.tif")

for (i in 1:length(MASS_images@layers)) {
  TITLE <- paste(TS[i], " (UTC)")
  name_time <- TS[i]
  MASS_images <- raster("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_NO2.tif", band = i)
  # plot(MASS_images)
...
WRF_STACK_image <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_SO2.tif")
output_folder <- "D:/Op_WRF_Chem/2017092800/images_png/12km_SO2/"
...
MASS_images <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_SO2.tif")

for (i in 1:length(MASS_images@layers)) {
  TITLE <- paste(TS[i], " (UTC)")
  name_time <- TS[i]
  MASS_images <- raster("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_SO2.tif", band = i)
  # plot(MASS_images)
...
WRF_STACK_image <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_O3.tif")
output_folder <- "D:/Op_WRF_Chem/2017092800/images_png/12km_O3/"
...
MASS_images <- stack("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_O3.tif")

for (i in 1:length(MASS_images@layers)) {
  TITLE <- paste(TS[i], " (UTC)")
  name_time <- TS[i]
  MASS_images <- raster("D:/Op_WRF_Chem/2017092800/AQ_12km_WRFChem_2017092800_O3.tif", band = i)
  # plot(MASS_images)
