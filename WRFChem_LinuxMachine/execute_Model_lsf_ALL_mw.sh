...
source /home/cesam/WRF_UAE/scripts/export.sh #/home/cesam/export.sh

#####################################################################################################################
main=/home/cesam/WRF_UAE/ ; scripts=$main/scripts/ ; wrf=$main/WRFV3/test/em_real/ ; wps=$main/WPS/ ; 
...
#################################### download Data ###################################################################
 ...
 for i in `seq -f %03.0f 0 6 72`; do
	...
	echo $i
      ...
      wget -c   -O gfs.t${date:8:2}z.pgrb2.0p25.f$i "http://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25.pl?file=gfs.t${date:8:2}z.pgrb2.0p25.f$i&all_lev=on&all_var=on&subregion=&leftlon=20.00&rightlon=120.00&toplat=40.00&bottomlat=00.00&dir=%2Fgfs.${date}" 
 done
...
#source "/home/cesam/WRFV3/wrfchem_env.txt"  
...
mpirun -n 50 ./real.exe

#bsub -n 60 -J job_name -o vk.%J.out -e vk.%J.err -q normal mpirun ./wrf.exe
echo WRF MET END""
############################################# WRF Met Ends ####################################################################
############################################# WRF CHEM ########################################################################
wrf_chem=/home/cesam/WRFV3/test/em_real/ ; an_ems=/home/cesam/ANTHRO/src ; wrf_met=/home/cesam/ANTHRO/metFiles 
db_ems=/home/cesam/EDGAR-HTAP/MOZCART/   ; wes=/home/cesam/WRFV3/wesely
wrfout=/research/cesam/WRFChem_outputs/${date} ; mkdir -p ${wrfout}  

# files for RECREMA website
dest_folder_RECREMA=/research/cesam/RECREMA/
##############################################################################################################################
...
for i in ${files[@]}; do
 ...
 # ncl 'file_in="'$i'"' 'file_out="./'$output'.nc"' /home/cesam/bin/wrfpost_dust_20170927_airquality.ncl
 ncl 'file_in="'$i'"' 'file_out="./'$output'.nc"' /home/cesam/WRF_UAE/scripts/wrfpost_dust_20170927_airquality.ncl
 done
...
#/apps/R/R-3.3.2/bin/Rscript /home/cesam/WRF_UAE/scripts/nc_WRFChem_post_proc_d01.R ${date}
Rscript /home/cesam/WRF_UAE/scripts/nc_WRFChem_post_proc_d01.R ${date}

# copy first 24h data from the previous day
Rscript /home/cesam/WRF_UAE/scripts/move_AQ_data_24h_day_before.R ${date} ${date_yesterday} 
# process AQI data
Rscript /home/cesam/WRF_UAE/scripts/AQI_WRFChem.R ${date}

# remove 24h day before .tif files
Rscript /home/cesam/WRF_UAE/scripts/remove_tif_24h_day_before.R ${date}

# remove AQI .tif files
# Rscript /home/cesam/WRF_UAE/scripts/AQI_tif_remover.R ${date}
...
# remove files
# Rscript /home/cesam/WRF_UAE/scripts/RECREMA_tif_remover.R

# synchronization on .66 machine (OceanColor)

rsync -avz ${wrfout}/PM10/*.tif /home/cesam/WRFChem_outputs/PM10
rsync -avz ${wrfout}/PM25/*.tif /home/cesam/WRFChem_outputs/PM25
rsync -avz ${wrfout}/SO2/*.tif /home/cesam/WRFChem_outputs/SO2
rsync -avz ${wrfout}/NO2/*.tif /home/cesam/WRFChem_outputs/NO2
rsync -avz ${wrfout}/CO/*.tif /home/cesam/WRFChem_outputs/CO
rsync -avz ${wrfout}/O3/*.tif /home/cesam/WRFChem_outputs/O3
rsync -avz ${wrfout}/AQI/*.tif /home/cesam/WRFChem_outputs/AQI

# remove files
# Rscript /home/cesam/WRF_UAE/scripts/OceanColor_tif_remover.R
